---
title: "DATA612 Project 3 Matrix Factorization"
author: "Omar Pineda"
date: "6/18/2020"
...
We notice that our matrix of ratings is sparse, meaning that there are users and items with few ratings, and this is a common issue in building recommender systems. Our resulting data set has 99 users and 30 healthcare products.

```{r}
hc2 <- spread(hc[, 1:3], product, rating) #convert table from long to wide
head(hc3)
```
